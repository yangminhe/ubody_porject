...
class Winos(QWidget):
    ...
    def initUI(self):
        ...
        PackageNameEdit = QLineEdit()
        PackageNameEdit.setPlaceholderText("APK包名称")


        Vsersion = QLabel('版本号')
        VsersionEdit = QLineEdit()
        VsersionEdit.setPlaceholderText("APK包版本号")


        Information = QLabel('发版信息')
        InformationEdit = QTextEdit()
        InformationEdit.setPlaceholderText("APK包发版信息")
